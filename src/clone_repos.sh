...
declare -A repos=(
    ...
    ["NaturalHistoryMuseum/ckanext-contact"]="v2.0.1"
    ["ckan/ckanext-googleanalytics"]="v2.4.0"
    ["ckan/ckanext-report"]="master"
    ["OpenDataGIS/ckanext-bne"]="develop"
    ["ckan/ckanext-showcase"]="v1.7.0"
)
